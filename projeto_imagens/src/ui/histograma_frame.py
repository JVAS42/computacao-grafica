...
class HistogramaFrame(ctk.CTkFrame):
    ...
    def construir_interface(self):
        ...
        # 1. Limpa todos os widgets existentes no frame (efeito de "trocar de aba")
        for widget in self.winfo_children():
            widget.destroy()

        # 2. Reseta as variáveis de estado
        ...
        # O botão resetar agora apenas chama o reconstruir_interface
