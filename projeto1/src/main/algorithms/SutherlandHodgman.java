...
public class SutherlandHodgman {
    ...
    // Recorta o polígono iterativamente contra as 4 bordas da janela
    public static List<Ponto> clipPolygon(List<Ponto> poligono, double xMin, double xMax, double yMin, double yMax) {
        ...
        resultado = clipEdge(resultado, xMin, xMax, yMin, yMax, 0); // Esquerda
        resultado = clipEdge(resultado, xMin, xMax, yMin, yMax, 1); // Direita
        resultado = clipEdge(resultado, xMin, xMax, yMin, yMax, 2); // Fundo/Top
        resultado = clipEdge(resultado, xMin, xMax, yMin, yMax, 3); // Topo/Bottom
        return resultado;
    }
    ...
    private static List<Ponto> clipEdge(List<Ponto> poligono, double xMin, double xMax, double yMin, double yMax, int edge) {
        ...
        Ponto p1 = poligono.get(poligono.size() - 1);
